  ...
  return (
    <header className="w-full flex items-center justify-between py-6 md:px-0 container mx-auto relative">
      ...
      <div className="hidden sm:flex items-center bg-[#F5F5F5] rounded-lg px-4 py-3 gap-2 w-full max-w-[372px]">
        ...
        <input type="text" placeholder="Search" className="bg-transparent outline-none text-[#989898] w-full text-sm font-medium" />
      </div>

      {/* Navigation*/}
      <nav className="hidden lg:flex items-center gap-[50px]">
        <NavLink to="/" className={({ isActive }) => (isActive ? 'text-black font-medium' : 'text-[#989898] hover:text-black font-medium transition-colors')}>
          Home
        </NavLink>
        <NavLink to="/about" className={({ isActive }) => (isActive ? 'text-black font-medium' : 'text-[#989898] hover:text-black font-medium transition-colors')}>
          About
        </NavLink>
        <NavLink to="/contact" className={({ isActive }) => (isActive ? 'text-black font-medium' : 'text-[#989898] hover:text-black font-medium transition-colors')}>
          Contact Us
        </NavLink>
        <NavLink to="/blog" className={({ isActive }) => (isActive ? 'text-black font-medium' : 'text-[#989898] hover:text-black font-medium transition-colors')}>
          Blog
        </NavLink>
      </nav>
